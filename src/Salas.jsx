...
<aside className="bg-teal-600 text-gray-700 p-4 h-screen w-50">
  ...
  <Link to="/salasinfo" className="block p-2 rounded-md text-white hover:bg-gray-700">
    Personal 
  </Link>
  <Link to="/IngresarPaciente" className="block p-2 rounded-md text-white hover:bg-gray-700">
    Pacientes
  </Link>
